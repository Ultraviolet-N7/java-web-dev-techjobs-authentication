...
public class AuthenticationFilter extends HandlerInterceptorAdapter {
    ...
    // Create list of pages that may be accessed by any user any time
    ...
    // Prevent access to every page on the app if a user is not logged in, check requests against whitelist
    @Override
